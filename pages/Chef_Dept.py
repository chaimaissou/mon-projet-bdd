...
<div class="main-header">
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <div>
            <h1 style="color: white; margin: 0; font-size: 1.75rem;">Département d'Informatique</h1>
...
if not examens_df.empty:
    ...
    if dept_conflits:
        st.markdown('<div class="card">', unsafe_allow_html=True)
        st.markdown('<p class="section-title">Alertes Spécifiques au Département</p>', unsafe_allow_html=True)
