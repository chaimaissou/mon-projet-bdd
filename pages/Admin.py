...
with tab1:
    ...
    st.markdown("---")
    st.markdown("**Vérification Disponibilité Salles**")
        ...
        with target_col:
            if salle['disponible']:
                ...
                padding: 1rem; border-radius: 8px; margin-bottom: 0.5rem;">
                    <strong style="color: #065f46;">{salle['code']} - {salle['nom']}</strong><br>
                    <span style="color: #065f46;">Type: {salle['type']} | Capacité: {salle['capacite']}</span><br>
                    <span style="color: #065f46;">Bâtiment: {salle['batiment']}</span><br>
                ...
                padding: 1rem; border-radius: 8px; margin-bottom: 0.5rem;">
                    <strong style="color: #991b1b;">{salle['code']} - {salle['nom']}</strong><br>
                    <span style="color: #991b1b;">Type: {salle['type']} | Capacité: {salle['capacite']}</span><br>
                    <span style="color: #991b1b;">Bâtiment: {salle['batiment']}</span><br>
                    <span style="color: #ef4444; font-weight: 600;">✗ OCCUPÉE</span>
                </div>
                """, unsafe_allow_html=True)
